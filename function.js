...
function test() {
    ...
    result.innerHTML = year.toString().slice(-1) + Math.ceil(days / 7) + source.options[source.selectedIndex].value + subject.options[subject.selectedIndex].value + style.options[style.selectedIndex].value + ratio.options[ratio.selectedIndex].value + number.toString().padStart(3, '0') + type.options[type.selectedIndex].value;
